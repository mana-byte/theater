...
#: `spawn_session`'s description, with the harness list left open. Filled from the local registry,
#: a hint — the daemon built its own; `list_harnesses` asks it for anything load-bearing.
