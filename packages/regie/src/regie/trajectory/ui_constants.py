...
# Trajectory exports stay private to Régie's data tree and bound each transcript block.
TRAJECTORY_EXPORT_SUBDIR = "trajectory-exports"
TRAJECTORY_EXPORT_PAYLOAD_MAX_CHARS = 16_000
TRAJECTORY_EXPORT_TRUNCATION_MARKER = "… [truncated: {count} characters omitted]"
TRAJECTORY_EXPORT_EMPTY_MESSAGE = "nothing to export"
