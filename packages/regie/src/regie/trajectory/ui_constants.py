...
TIMELINE_HEIGHT = 16
TIMELINE_COMPACT_HEIGHT = 11
TIMELINE_LABEL_WIDTH = 13
TIMELINE_LABEL_RIGHT_PADDING = 3
TIMELINE_LANE_HEIGHT = 3
TIMELINE_COMPACT_LANE_HEIGHT = 2
# Below this many rows the view uses compact lanes so details keep room.
TRAJECTORY_COMPACT_VIEW_HEIGHT = 40
