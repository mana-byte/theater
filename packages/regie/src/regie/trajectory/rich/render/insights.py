...
from regie.trajectory.domain import ParticipantLink, TrajectoryStatus
...
from regie.trajectory.rich.analysis.waterfall import timing_interval
from regie.trajectory.rich.enums import DiagnosticView
from regie.trajectory.rich.render.records import (
    compact_cost,
    compact_number,
    format_duration,
    sanitize_text,
