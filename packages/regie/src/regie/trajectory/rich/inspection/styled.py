...
from regie.trajectory.rich.inspection.project import (
    project_record_details,
)
from regie.trajectory.rich.inspection.rich_content import (
    DetailDocument,
    DetailStyles,
    formatted_value,
)
from regie.trajectory.rich.inspection.tools import project_tool_details
