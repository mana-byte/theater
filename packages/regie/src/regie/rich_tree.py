...
- :mod:`regie.render.layout` — key types, path shortening, forest walk
- :mod:`regie.render.glyphs` — spinner, working pulse, status, overlays
- :mod:`regie.render.routing` — rail grid, BFS routes, send/await traces

Immutable UI values live in :mod:`regie.ui_constants`. This module
...
from regie.render.layout import (
    Key,
    _labelled,
    _walk,
    is_root_prefix,
